...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body className="min-h-screen bg-brand-background text-brand-textPrimary font-sans antialiased selection:bg-blue-100 selection:text-blue-900">
        <LocaleProvider>

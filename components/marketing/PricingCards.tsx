  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-wrap items-center justify-center gap-2">
        <span className="text-xs font-semibold text-brand-textSecondary mr-2">
          {t("viewPricingIn")}
        </span>
          ...
          return (
            <button
              ...
              className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-bold transition-all cursor-pointer ${
                isSelected
                  ? "bg-brand-darkNavy text-white shadow-md scale-105 ring-2 ring-brand-blue/30"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
        {/* Tier 1: Free User */}
        <div className="bg-white border border-brand-border rounded-card p-6 shadow-subtle space-y-6 flex flex-col justify-between hover:border-slate-300 transition-colors">
          <div className="space-y-4">
            <div>
              ...
              <h3 className="text-2xl font-extrabold font-heading text-brand-darkNavy mt-1">
                {formatPrice(0)}
              </h3>
        ...
        <div className="bg-white border-2 border-emerald-600 rounded-card p-6 shadow-card space-y-6 flex flex-col justify-between relative transform hover:-translate-y-1 transition-all">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5 text-xs text-brand-textSecondary border-t pt-4">
              ...
              <li className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" />
                <span>Instant FIRS-Compliant VAT Tax Receipt</span>
              </li>
              <li className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" />
        ...
        <div className="bg-slate-900 text-white border-2 border-brand-blue/60 hover:border-brand-blue rounded-2xl p-6 shadow-xl space-y-6 flex flex-col justify-between relative transform hover:-translate-y-1 transition-all">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-xs text-slate-300 border-t border-slate-800/90 pt-4">
              ...
              <li className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
                <span>Unlimited AI Due-Diligence Assistant Inquiries</span>
              </li>
              <li className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
      ...
      <div className="text-center pt-2">
        <p className="text-xs text-brand-textSecondary flex items-center justify-center gap-1.5">
          ...
          <span>Secured by <strong>Paystack</strong>. Accepts Mastercard, Visa, Verve, Apple Pay & International Bank Cards.</span>
        </p>
      </div>
    </div>
  );

  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6 max-w-6xl mx-auto">
        {/* Tier 1: Free User */}
        <div className="bg-white border border-brand-border rounded-xl sm:rounded-card p-4 sm:p-6 shadow-card space-y-5 sm:space-y-6 flex flex-col justify-between hover:border-brand-blue/40 transition-colors">
          <div className="space-y-3 sm:space-y-4">
            <div>
              <h3 className="text-xs font-bold text-slate-800 uppercase tracking-wider">
                {t("preliminaryEvaluation") || "Preliminary Evaluation"}
              </h3>
              <div className="text-2xl sm:text-3xl font-extrabold font-heading text-brand-darkNavy mt-1">
                {formatPrice(0)}
              </div>
        ...
        <div className="bg-white border-2 border-emerald-600 rounded-xl sm:rounded-card p-4 sm:p-6 shadow-card space-y-5 sm:space-y-6 flex flex-col justify-between relative transform hover:-translate-y-1 transition-all">
          <span className="absolute -top-3 right-4 sm:right-6 bg-emerald-700 text-white text-[10px] font-bold px-2.5 sm:px-3 py-0.5 rounded-pill tracking-wider uppercase shadow-xs">
        ...
        <div className="bg-slate-900 text-white border-2 border-brand-blue/60 hover:border-brand-blue rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-xl space-y-5 sm:space-y-6 flex flex-col justify-between relative transform hover:-translate-y-1 transition-all">
          <span className="absolute -top-3 right-4 sm:right-6 bg-brand-blue text-white text-[10px] font-extrabold px-2.5 sm:px-3 py-0.5 rounded-full tracking-wider uppercase shadow-xs">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <ul className="space-y-2 text-xs text-slate-200 border-t border-slate-800/90 pt-3 sm:pt-4">
              <li className="flex items-center gap-2">
